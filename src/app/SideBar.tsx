                  ...
                  <nav className="flex flex-1 flex-col">
                    <ul role="list" className="flex flex-1 flex-col gap-y-7">
                      ...
                      <li className="mt-auto">
                        <Link
                          href="/settings"
                          className="group -mx-2 flex gap-x-3 rounded-md p-2 text-sm font-semibold leading-6 text-emerald-200 hover:bg-emerald-700 hover:text-white"
                        >
                          <Cog6ToothIcon
                            className="h-6 w-6 shrink-0 text-emerald-200 group-hover:text-white"
                            aria-hidden="true"
                          />
                          Paramètres
                        </Link>
